...
FEATURE_NAMES = {'distance_m':'VKT',
                ...
                'ft_employment_access_v2_01':'Distance to Employment',
                'ft_employment_access_v2_05':'Distance to 5% Employment',
                'ft_income':'Income',
...
def get_path_root():
    config = load_config()
    if config['path_mount'] is not None:
        return os.path.join(config['path_mount'],config['path_data'])
    else: 
